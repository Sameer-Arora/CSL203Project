...
$(document).ready(function(){
    ...
    // cv_letter_id = cv_letter_id in my case. find alternative
    ...
    $('.rate_widget').each(function(i) {
            ...
            var da="cv_letter_id="+cv_letter_id+"&fetch=2";
            //alert (da);

            $.ajax({
                type:"POST",
                dataType:"text",
                url:"./test/ratingcv_letter.php",  
                data: da,
    ...
    $('.row').on('click','.ratings_stars', function() {
            ...
            var da="cv_letter_id="+cv_letter_id+"&clicked_on="+clicked_on;
            //alert (da);
