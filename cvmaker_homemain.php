...
<div class="alert alert-danger alert-dismissible fade show hide " role="alert">
  ...
  <button type="button" class="close" data-hide="alert"  aria-label="Close">
    ...
    <div class="container-fluid">
      ...
      <div id="your" class="row flex-row flex-nowrap scroll  scroll" >
                ...
                <div class="card-content">
                  <div class="card-body">
                    <form class="form" id="upload" action="upload.php" method="post" enctype="multipart/form-data">
                      ...
                      name="fileToUpload" id="fileToUpload" data-max-file-size="3M" max-height="10em" required pattern="^[a-zA-Z0-9_]+$" title="Enter a valid filename with no spaces.">
                  ...
                  <div class="card-body" id="<?php echo $row['cv_id'];?>" >
                    ...
                    <div class="options">
                        <ul class="option">
                          ...
                          <li><i class="far fa-trash fa-2x "></i></li>
                          <li><i class="far fa-edit fa-2x"></i></li>
                          <li> Share
                            <label class="switch">
                              <input type="checkbox">
      ...
      <span id="" class="heading" >MED Templates</span>
      <div class="row flex-row flex-nowrap scroll ">
          <?php
